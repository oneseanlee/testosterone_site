...
const Footer = () => {
    return (
        <footer className="bg-navy text-white">
            {/* Main Footer */}
            <div className="py-16" style={{ paddingLeft: '7.8125vw', paddingRight: '7.8125vw' }}>
            ...
            {/* Disclaimers */}
            <div className="border-t border-white/10 py-8" style={{ paddingLeft: '7.8125vw', paddingRight: '7.8125vw' }}>
            ...
            {/* Copyright */}
            <div className="border-t border-white/10 py-6 text-center" style={{ paddingLeft: '7.8125vw', paddingRight: '7.8125vw' }}>
